// $ANTLR 3.2 Sep 23, 2009 12:02:23 Dart.g 2011-11-17 08:45:48
...
public partial class DartLexer : Lexer {
    ...
    public void mIDENTIFIER_NO_DOLLAR() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:64:5: ( IDENTIFIER_START_NO_DOLLAR ( IDENTIFIER_PART_NO_DOLLAR )* )
            // Dart.g:64:7: IDENTIFIER_START_NO_DOLLAR ( IDENTIFIER_PART_NO_DOLLAR )*
            {
            	mIDENTIFIER_START_NO_DOLLAR(); if (state.failed) return ;
            	// Dart.g:64:34: ( IDENTIFIER_PART_NO_DOLLAR )*
            	do 
            	{
            	    int alt1 = 2;
    ...
    public void mIDENTIFIER() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:68:5: ( IDENTIFIER_START ( IDENTIFIER_PART )* )
            // Dart.g:68:7: IDENTIFIER_START ( IDENTIFIER_PART )*
            {
            	mIDENTIFIER_START(); if (state.failed) return ;
            	// Dart.g:68:24: ( IDENTIFIER_PART )*
            	do 
            	{
            	    int alt2 = 2;
    ...
    public void mHEX_NUMBER() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:72:5: ( '0x' ( HEX_DIGIT )+ | '0X' ( HEX_DIGIT )+ )
            int alt5 = 2;
            ...
            {
                case 1 :
                    // Dart.g:72:7: '0x' ( HEX_DIGIT )+
                    {
                    	Match("0x"); if (state.failed) return ;

                    	// Dart.g:72:12: ( HEX_DIGIT )+
                    	int cnt3 = 0;
                    	do 
                    	{
                    	    int alt3 = 2;
                    ...
                    break;
                case 2 :
                    // Dart.g:73:7: '0X' ( HEX_DIGIT )+
                    {
                    	Match("0X"); if (state.failed) return ;

                    	// Dart.g:73:12: ( HEX_DIGIT )+
                    	int cnt4 = 0;
                    	do 
                    	{
                    	    int alt4 = 2;
    ...
    public void mNUMBER() // throws RecognitionException [2]
    {
            ...
            int _type = NUMBER;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:77:5: ( ( DIGIT )+ NUMBER_OPT_FRACTIONAL_PART ( EXPONENT )? NUMBER_OPT_ILLEGAL_END | '.' ( DIGIT )+ ( EXPONENT )? NUMBER_OPT_ILLEGAL_END )
            int alt10 = 2;
            ...
            {
                case 1 :
                    // Dart.g:77:7: ( DIGIT )+ NUMBER_OPT_FRACTIONAL_PART ( EXPONENT )? NUMBER_OPT_ILLEGAL_END
                    {
                    	// Dart.g:77:7: ( DIGIT )+
                    	int cnt6 = 0;
                    	do 
                    ...
                    break;
                case 2 :
                    // Dart.g:78:7: '.' ( DIGIT )+ ( EXPONENT )? NUMBER_OPT_ILLEGAL_END
                    {
    ...
    public void mNUMBER_OPT_ILLEGAL_END() // throws RecognitionException [2]
    {
            ...
            {
                case 1 :
                    // Dart.g:87:7: ( IDENTIFIER_START )=>
                    {
                    	if ( (state.backtracking==0) )
                    	{
                    	   error("numbers cannot contain identifiers"); 
                    	}
    ...
    public void mIDENTIFIER_START() // throws RecognitionException [2]
    {
    		try
    		{
            // Dart.g:98:5: ( IDENTIFIER_START_NO_DOLLAR | '$' )
            // Dart.g:
            {
    ...
    public void mIDENTIFIER_PART_NO_DOLLAR() // throws RecognitionException [2]
    {
    		try
    		{
            // Dart.g:108:5: ( IDENTIFIER_START_NO_DOLLAR | DIGIT )
            // Dart.g:
            {
    ...
    public void mIDENTIFIER_PART() // throws RecognitionException [2]
    {
    		try
    		{
            // Dart.g:113:5: ( IDENTIFIER_START | DIGIT )
            // Dart.g:
            {
    ...
    public void mEXPONENT() // throws RecognitionException [2]
    {
    		try
    		{
            // Dart.g:128:5: ( ( 'e' | 'E' ) ( '+' | '-' )? ( DIGIT )+ )
            // Dart.g:128:7: ( 'e' | 'E' ) ( '+' | '-' )? ( DIGIT )+
            {
    ...
    public void mSTRING() // throws RecognitionException [2]
    {
            ...
            int _type = STRING;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:132:5: ( ( '@' )? MULTI_LINE_STRING | SINGLE_LINE_STRING )
            int alt17 = 2;
            alt17 = dfa17.Predict(input);
            switch (alt17) 
            {
                case 1 :
                    // Dart.g:132:7: ( '@' )? MULTI_LINE_STRING
                    {
                    	// Dart.g:132:7: ( '@' )?
                    	int alt16 = 2;
                    ...
                    break;
                case 2 :
                    // Dart.g:133:7: SINGLE_LINE_STRING
                    {
    ...
    public void mSINGLE_LINE_STRING() // throws RecognitionException [2]
    {
    		try
    		{
            // Dart.g:143:5: ( '\"' ( STRING_CONTENT_DQ )* '\"' | '\\'' ( STRING_CONTENT_SQ )* '\\'' | '@' '\\'' (~ ( '\\'' | NEWLINE ) )* '\\'' | '@' '\"' (~ ( '\"' | NEWLINE ) )* '\"' )
            int alt25 = 4;
            switch ( input.LA(1) ) 
            {
            case '\"':
            ...
            {
                case 1 :
                    // Dart.g:143:7: '\"' ( STRING_CONTENT_DQ )* '\"'
                    {
                    	Match('\"'); if (state.failed) return ;
                    	// Dart.g:143:11: ( STRING_CONTENT_DQ )*
                    	do 
                    	{
                    	    int alt21 = 2;
                    ...
                    break;
                case 2 :
                    // Dart.g:144:7: '\\'' ( STRING_CONTENT_SQ )* '\\''
                    {
                    	Match('\''); if (state.failed) return ;
                    	// Dart.g:144:12: ( STRING_CONTENT_SQ )*
                    	do 
                    	{
                    	    int alt22 = 2;
                    ...
                    break;
                case 3 :
                    // Dart.g:145:7: '@' '\\'' (~ ( '\\'' | NEWLINE ) )* '\\''
                    {
                    	Match('@'); if (state.failed) return ;
                    	Match('\''); if (state.failed) return ;
                    	// Dart.g:145:16: (~ ( '\\'' | NEWLINE ) )*
                    	do 
                    	{
                    	    int alt23 = 2;
    ...
    public void mBAD_STRING() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:165:5: ( UNTERMINATED_STRING NEWLINE )
            // Dart.g:165:7: UNTERMINATED_STRING NEWLINE
            {
    ...
    public void mHASHBANG() // throws RecognitionException [2]
    {
            ...
            int _type = HASHBANG;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:174:5: ( '#!' (~ ( NEWLINE ) )* ( NEWLINE )? )
            // Dart.g:174:7: '#!' (~ ( NEWLINE ) )* ( NEWLINE )?
            {
            	Match("#!"); if (state.failed) return ;

            	// Dart.g:174:12: (~ ( NEWLINE ) )*
            	do 
            	{
            	    int alt33 = 2;
    ...
    public void mWHITESPACE() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:181:5: ( ( '\\t' | ' ' | NEWLINE )+ )
            // Dart.g:181:7: ( '\\t' | ' ' | NEWLINE )+
            {
            	// Dart.g:181:7: ( '\\t' | ' ' | NEWLINE )+
            	int cnt35 = 0;
            	do 
    ...
    public void mSINGLE_LINE_COMMENT() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:185:5: ( '//' (~ ( NEWLINE ) )* ( NEWLINE )? )
            // Dart.g:185:7: '//' (~ ( NEWLINE ) )* ( NEWLINE )?
            {
            	Match("//"); if (state.failed) return ;

            	// Dart.g:185:12: (~ ( NEWLINE ) )*
            	do 
            	{
            	    int alt36 = 2;
    ...
    public void mMULTI_LINE_COMMENT() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Dart.g:189:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // Dart.g:189:7: '/*' ( options {greedy=false; } : . )* '*/'
            {
            	Match("/*"); if (state.failed) return ;

            	// Dart.g:189:12: ( options {greedy=false; } : . )*
            	do 
            	{
            	    int alt38 = 2;
    ...
    protected class DFA17 : DFA
    {
        ...
        {
            get { return "131:1: STRING : ( ( '@' )? MULTI_LINE_STRING | SINGLE_LINE_STRING );"; }
        }
